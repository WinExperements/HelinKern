...
all: $(OBJECTS) $(MODULE_OBJS)
	...
	@echo [LD] kernel.bin
	@$(CCPATH)ld -melf_i386 -T src/arch/$(ARCH)/linker.ld -o kernel.bin $(OBJECTS) $(MODULE_OBJS)
clean:
